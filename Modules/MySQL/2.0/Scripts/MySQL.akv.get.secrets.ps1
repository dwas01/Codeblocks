<#
	.NOTES
		...
		File:		MySQL.akv.get.secrets.ps1

		Purpose:	Get MySQL Database Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get MySQL Database Key Secrets as Azure DevOps variables.
	...
	.EXAMPLE
		Default:
		C:\PS>.\MySQL.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("mySQLName","MySQL--Name")
	$kvSecretNames.Add("mySQLResourceId","MySQL--ResourceId")
	$kvSecretNames.Add("mySQLResourceGroup","MySQL--ResourceGroup")
