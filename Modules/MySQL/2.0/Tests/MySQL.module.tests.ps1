<#
	.NOTES
		...
		File:		MySQL.module.tests.ps1

		Purpose:	Pester - Test MySQL Database ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test MySQL Database ARM template synatax.
...
Describe "Template: $template - MySQL Database" -Tags -Unit {
