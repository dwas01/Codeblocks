<#
	.NOTES
		...
		File:		RecoveryServicesVaults.module.tests.ps1

		Purpose:	Pester - Test Recovery Services Vaults ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Recovery Services Vaults ARM template synatax.
...
Describe "Template: $template - Recovery Services Vaults" -Tags -Unit {
