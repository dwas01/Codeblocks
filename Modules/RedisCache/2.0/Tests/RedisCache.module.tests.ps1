<#
	.NOTES
		...
		File:		RedisCache.module.tests.ps1

		Purpose:	Pester - Test Azure Cache for Redis ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Cache for Redis ARM template synatax.
...
Describe "Template: $template - Azure Cache for Redis" -Tags -Unit {
