<#
	.NOTES
		...
		File:		ApplicationSecurityGroups.module.tests.ps1

		Purpose:	Pester - Test Application Security Groups ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Application Security Groups ARM template synatax.
...
Describe "Template: $template - Application Security Groups" -Tags -Unit {
