<#
	.NOTES
		...
		File:		KubernetesAKS.akv.get.operational.secrets.ps1
	...
	.PARAMETER aksPodIdentityName
		Specify the Azure AKS Cluster Pod Identity Name parameter.

	.EXAMPLE
		Default:
		C:\PS>.\KubernetesAKS.akv.get.operational.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("aksPodIdentityName","aksPodIdentity--Name--$($aksPodIdentityName)")
	$kvSecretNames.Add("aksPodIdentityResourceId","aksPodIdentity--ResourceId--$($aksPodIdentityName)")
	$kvSecretNames.Add("aksPodIdentityResourceGroup","aksPodIdentity--ResourceGroup--$($aksPodIdentityName)")
