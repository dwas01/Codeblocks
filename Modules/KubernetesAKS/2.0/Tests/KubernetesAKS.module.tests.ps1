<#
	.NOTES
		...
		File:		KubernetesAKS.module.tests.ps1

		Purpose:	Pester - Test Kubernetes Cluster ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Kubernetes Cluster ARM template synatax.
...
Describe "Template: $template - Kubernetes Cluster" -Tags -Unit {
