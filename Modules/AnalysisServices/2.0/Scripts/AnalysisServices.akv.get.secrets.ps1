<#
	.NOTES
		...
		File:		AnalysisServices.akv.get.secrets.ps1

		Purpose:	Get Analysis Services Key Secrets as Azure DevOps variables
	...
	.EXAMPLE
		Default:
		C:\PS>.\AnalysisServices.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("analysisServicesName","AnalysisServices--Name--$($analysisServicesName)")
	$kvSecretNames.Add("analysisServicesResourceId","AnalysisServices--ResourceId--$($analysisServicesName)")
	$kvSecretNames.Add("analysisServicesResourceGroup","AnalysisServices--ResourceGroup--$($analysisServicesName)")
