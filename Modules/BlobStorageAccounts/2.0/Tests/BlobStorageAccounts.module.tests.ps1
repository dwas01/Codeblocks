<#
	.NOTES
		...
		File:		BlobStorageAccounts.module.tests.ps1

		Purpose:	Pester - Test Blob Storage Account ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Blob Storage Account ARM template synatax.
...
Describe "Template: $template - Blob Storage Account" -Tags -Unit {
