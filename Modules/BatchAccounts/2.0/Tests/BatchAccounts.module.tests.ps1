<#
	.NOTES
		...
		File:		BatchAccounts.module.tests

		Purpose:	Pester - Test Azure Batch Account ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Batch Account ARM template synatax.
...
Describe "Template: $template - Azure Batch Account" -Tags -Unit {
