<#
	.NOTES
		...
		File:		SearchServices.module.tests.ps1

		Purpose:	Pester - Test Azure Cognitive Search ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Cognitive Search ARM template synatax.
...
Describe "Template: $template - Azure Cognitive Search" -Tags -Unit {
