<#
	.NOTES
		...
		File:		NotificationHubs.module.tests.ps1

		Purpose:	Pester - Test Notification Hubs ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Notification Hubs ARM template synatax.
...
Describe "Template: $template - Notification Hubs" -Tags -Unit {
