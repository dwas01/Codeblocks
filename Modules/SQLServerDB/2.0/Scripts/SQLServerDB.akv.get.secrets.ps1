<#
	.NOTES
		...
		File:		SQLServerDB.akv.get.secrets.ps1

		Purpose:	Get SQL Server Database Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get SQL Server Database Key Secrets as Azure DevOps variables.
	...
	.EXAMPLE
		Default:
		C:\PS>.\SQLServerDB.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("sqlServerdbName","SqlServerdb--Name--$($sqlServerdbName)")
	$kvSecretNames.Add("sqlServerdbResourceId","SqlServerdb--ResourceId--$($sqlServerdbName)")
	$kvSecretNames.Add("sqlServerdbResourceGroup","SqlServerdb--ResourceGroup--$($sqlServerdbName)")
