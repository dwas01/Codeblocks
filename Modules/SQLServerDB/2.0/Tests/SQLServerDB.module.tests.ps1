<#
	.NOTES
		...
		File:		SQLServerDB.module.tests.ps1

		Purpose:	Pester - Test SQL Server Database ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test SQL Server Database ARM template synatax.
...
Describe "Template: $template - SQL Server Database" -Tags -Unit {
