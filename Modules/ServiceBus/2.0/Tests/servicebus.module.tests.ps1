<#
	.NOTES
		...
		File:		ServiceBus.module.tests.ps1

		Purpose:	Pester - Test Service Bus ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Analysis Services ARM template synatax.
...
Describe "Template: $template - Service Bus" -Tags -Unit {
	...
	Context "Template File Syntax" {
		...
		It "Converts from JSON and has the expected Azure Resources" -TestCases $templateFileTestCases {
			...
			'Microsoft.ServiceBus/namespaces/AuthorizationRule'
