<#
	.NOTES
		...
		File:		CognitiveServices.akv.get.secrets.ps1

		Purpose:	Get Cognitive Services Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get Cognitive Services Key Secrets as Azure DevOps variables.
	...
	.DESCRIPTION
		...
		2) Get Cognitive Services Secrets
	...
	.EXAMPLE
		Default:
		C:\PS>.\CognitiveServices.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("cognitiveServicesName","CognitiveServices--Name--$($cognitiveServicesName)")
	$kvSecretNames.Add("cognitiveServicesResourceId","CognitiveServices--ResourceId--$($cognitiveServicesName)")
	$kvSecretNames.Add("cognitiveServicesResourceGroup","CognitiveServices--ResourceGroup--$($cognitiveServicesName)")
