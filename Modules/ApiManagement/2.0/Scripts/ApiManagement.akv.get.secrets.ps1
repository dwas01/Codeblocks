<#
	.NOTES
		...
		File:		ApiManagement.akv.get.secrets.ps1

		Purpose:	Get Api Management Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get Api Management Key Secrets as Azure DevOps variables.
	...
	.EXAMPLE
		Default:
		C:\PS>.\ApiManagement.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("apimServiceName","ApiMService--Name--$($apimServiceName)")
	$kvSecretNames.Add("apimServiceResourceId","ApiMService--ResourceId--$($apimServiceName)")
	$kvSecretNames.Add("apimServiceResourceGroup","ApiMService--ResourceGroup--$($apimServiceName)")
