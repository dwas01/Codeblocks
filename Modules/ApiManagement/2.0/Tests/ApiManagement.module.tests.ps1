<#
	.NOTES
		...
		File:		ApiManagement.module.tests.ps1

		Purpose:	Pester - Test Api Management Service ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Api Management Service ARM template synatax.
