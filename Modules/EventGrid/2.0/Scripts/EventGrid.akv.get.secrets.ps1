<#
	.NOTES
		...
		File:		EventGrid.akv.get.secrets.ps1

		Purpose:	Get Event Grid Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get Event Grid Key Secrets as Azure DevOps variables.
	...
	.EXAMPLE
		Default:
		C:\PS>.\EventGrid.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("eventGridName","EventGrid--Name--$($eventGridName)")
	$kvSecretNames.Add("eventGridResourceId","EventGrid--ResourceId--$($eventGridName)")
	$kvSecretNames.Add("eventGridResourceGroup","EventGrid--ResourceGroup--$($eventGridName)")
