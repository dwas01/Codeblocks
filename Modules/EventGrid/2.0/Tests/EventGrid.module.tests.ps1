<#
	.NOTES
		...
		File:		EventGrid.module.tests.ps1

		Purpose:	Pester - Test Event Grid ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Event Grid ARM template synatax.
...
Describe "Template: $template - Event Grid" -Tags -Unit {
