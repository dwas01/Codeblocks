<#
	.NOTES
		...
		File:		NetworkSecurityGroups.module.tests.ps1

		Purpose:	Pester - Test Network Security Groups ARM Templates
...
Describe "Template: $template - Network Security Groups" -Tags -Unit {
