<#
	.NOTES
		...
		File:		VirtualNetworkPeering.akv.get.secrets.ps1

		Purpose:	Get Virtual Network Peering Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get Virtual Network Peering Key Secrets as Azure DevOps variables.
	...
	.DESCRIPTION
		...
		2) Get Virtual Network Peering Secrets
	...
	.EXAMPLE
		Default:
		C:\PS>.\VirtualNetworkPeering.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("vNetPeeringName","vNetPeering--Name--$($vNetPeeringName)")
	$kvSecretNames.Add("vNetPeeringResourceId","vNetPeering--ResourceId--$($vNetPeeringName)")
	$kvSecretNames.Add("vNetPeeringResourceGroup","vNetPeering--ResourceGroup--$($vNetPeeringName)")
