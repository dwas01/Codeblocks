<#
	.NOTES
		...
		File:		Cosmosdb.module.tests.ps1

		Purpose:	Pester - Test Cosmosdb Database Account ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Cosmosdb Database Account ARM template synatax.
...
Describe "Template: $template - Cosmosdb Database Account" -Tags -Unit {
