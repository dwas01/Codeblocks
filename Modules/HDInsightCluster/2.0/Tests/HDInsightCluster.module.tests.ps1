<#
	.NOTES
		...
		File:		HDInsightCluster.module.tests.ps1

		Purpose:	Pester - Test HDInsight Cluster ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test HDInsight Cluster ARM template synatax.
...
Describe "Template: $template - HDInsight Cluster" -Tags -Unit {
