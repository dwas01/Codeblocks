<#
	.NOTES
		...
		File:		ContainerRegistries.module.tests.ps1

		Purpose:	Pester - Test Container Registries ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Container Registries ARM template synatax.
...
Describe "Template: $template - Container Registries" -Tags -Unit {
