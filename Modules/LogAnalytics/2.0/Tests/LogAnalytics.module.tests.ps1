<#
	.NOTES
		...
		File:		LogAnalytics.module.tests.ps1

		Purpose:	Pester - Test Log Analytics ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Log Analytics ARM template synatax.
...
Describe "Template: $template - Log Analytics" -Tags -Unit {
