<#
	.NOTES
		...
		File:		RouteTable.module.tests.ps1

		Purpose:	Pester - Test Route Table ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Route Table ARM template synatax.
...
Describe "Template: $template - Route Table" -Tags -Unit {
