<#
	.NOTES
		...
		File:		PostgreSQL.module.tests.ps1

		Purpose:	Pester - Test PostgreSQL ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test PostgreSQL ARM template synatax.
