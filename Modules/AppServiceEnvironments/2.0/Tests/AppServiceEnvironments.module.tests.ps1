<#
	.NOTES
		...
		File:		AppServiceEnvironments.module.tests.ps1

		Purpose:	Pester - Test Application Service Environment ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Application Service Environment ARM template synatax.
...
Describe "Template: $template - Application Service Environment" -Tags -Unit {
