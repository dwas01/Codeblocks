<#
	.NOTES
		...
		File:		AzureAutomationAccount.module.tests.ps1

		Purpose:	Pester - Test Azure Automation Account ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Automation Account ARM template synatax.
...
Describe "Template: $template - Azure Automation Account" -Tags -Unit {
