<#
	.NOTES
		...
		File:		DataFactories.module.tests.ps1

		Purpose:	Pester - Test Azure Data Factories ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Data Factories ARM template synatax.
...
Describe "Template: $template - Azure Data Factories" -Tags -Unit {
