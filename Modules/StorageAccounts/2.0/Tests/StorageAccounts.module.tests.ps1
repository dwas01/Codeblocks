<#
	.NOTES
		...
		File:		StorageAccounts.module.tests.ps1

		Purpose:	Pester - Test Storage Accounts ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Storage Accounts ARM template synatax.
