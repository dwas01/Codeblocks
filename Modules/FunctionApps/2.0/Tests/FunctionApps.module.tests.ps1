<#
	.NOTES
		...
		File:		FunctionApps.module.tests.ps1

		Purpose:	Pester - Test Azure Functions ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Functions ARM template synatax.
...
Describe "Template: $template - Azure Functions" -Tags -Unit {
