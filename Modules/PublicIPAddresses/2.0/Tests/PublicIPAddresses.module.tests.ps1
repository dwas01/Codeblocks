<#
	.NOTES
		...
		File:		PublicIPAddresses.module.tests.ps1

		Purpose:	Pester - Test Public IP Address ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Public IP Address ARM template synatax.
