<#
	.NOTES
		...
		File:		SQLServer.module.tests.ps1

		Purpose:	Pester - Test SQL Server ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test SQL Server ARM template synatax.
...
Describe "Template: $template - SQL Server" -Tags -Unit {
