<#
	.NOTES
		...
		File:		LogicApps.akv.get.secrets.ps1

		Purpose:	Get Azure Logic Apps Key Secrets as Azure DevOps variables
	...
	.SYNOPSIS
		Get Azure Logic Apps Key Secrets as Azure DevOps variables.
	...
	.DESCRIPTION
		...
		2) Get Azure Logic Apps Secrets
	...
	.EXAMPLE
		Default:
		C:\PS>.\LogicApps.akv.get.secrets.ps1
...
{
	$kvSecretNames = @{ }
	$kvSecretNames.Add("logicAppsName","LogicApps--Name--$($logicAppsName)")
	$kvSecretNames.Add("logicAppsResourceId","LogicApps--ResourceId--$($logicAppsName)")
	$kvSecretNames.Add("logicAppsResourceGroup","LogicApps--ResourceGroup--$($logicAppsName)")
