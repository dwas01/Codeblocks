<#
	.NOTES
		...
		File:		LogicApps.module.tests.ps1

		Purpose:	Pester - Test Azure Logic Apps ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Logic Apps ARM template synatax.
...
Describe "Template: $template - Azure Logic Apps" -Tags -Unit {
