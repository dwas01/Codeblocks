<#
	.NOTES
		...
		File:		MachineLearningServices.module.tests.ps1

		Purpose:	Pester - Test Machine Learning Services ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Machine Learning Servicess ARM template synatax.

	.DESCRIPTION
		This script contains functionality used to test Machine Learning Services ARM template synatax.
...
Describe "Template: $template - Machine Learning Services" -Tags -Unit {
