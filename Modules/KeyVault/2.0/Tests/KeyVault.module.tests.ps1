<#
	.NOTES
		...
		File:		KeyVault.module.tests.ps1

		Purpose:	Pester - Test KeyVault ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test KeyVault ARM template synatax.
...
Describe "Template: $template - KeyVault" -Tags -Unit {
