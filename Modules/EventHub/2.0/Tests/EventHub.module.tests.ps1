<#
	.NOTES
		...
		File:		EventHub.module.tests.ps1

		Purpose:	Pester - Test Event Hub ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Event Hub ARM template synatax.
...
Describe "Template: $template - Event Hub" -Tags -Unit {
