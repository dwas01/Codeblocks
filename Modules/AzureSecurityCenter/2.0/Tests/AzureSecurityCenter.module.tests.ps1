<#
	.NOTES
		...
		File:		AzureSecurityCenter.module.tests.ps1

		Purpose:	Pester - Test Azure Security Center ARM Templates
	...
	.SYNOPSIS
		This script contains functionality used to test Azure Security Center ARM template synatax.
...
Describe "Template: $template - Azure Security Center" -Tags -Unit {
